...
```
  ...
  这里遇到k3s里crictl无法下载kiali镜像, 这里推荐使用 `docker pull quay.io/kiali/kiali:v1.34` && `docker save -o kiali.tar quay.io/kiali/kiali:v1.34` && `sudo k3s ctr images import kiali.tar `
