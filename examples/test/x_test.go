...
func TestArticleBatchDel(t *testing.T) {
	x.Handle("DELETE", "/api/article/batch_del", XTestArticleBatchDel, t, XTestArticleBatchDelRequest)
}
...
// go test -v -test.run TestArticleTodo
func TestArticleTodo(t *testing.T) {
	x.Handle("GET", "/api/article/todo", XTestArticleTodo, t, XTestArticleTodoRequest)
}

// BenchmarkArticleTodo defined TODO
// go test -v -test.run=none -test.bench=^BenchmarkArticleTodo -test.benchmem=true
func BenchmarkArticleTodo(t *testing.B) {
	t.RunParallel(func(pb *testing.PB) {
		for pb.Next() {
			x.Handle("GET", "/api/article/todo", XTestArticleTodo, t, XTestArticleTodoRequest)
		}
