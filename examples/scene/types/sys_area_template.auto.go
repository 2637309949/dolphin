...
type SysAreaTemplate struct {
	...
	Type null.Int `xorm:"int(11) comment('模板类型 0:固定模板 1:动态模板 2:自定义模板') 'type'" json:"type" form:"type" xml:"type"`
	// Default defined 是否默认 1：是 0：否
	Default null.Int `xorm:"int(11) comment('是否默认 1：是 0：否') 'default'" json:"default" form:"default" xml:"default"`
	// Creater defined 创建人
