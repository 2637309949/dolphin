...
// McQuestion defined 问题表
type McQuestion struct {
	// QuestionId defined 问题ID
	QuestionId null.Int `xorm:"int(11) pk notnull autoincr comment('问题ID') 'question_id'" json:"question_id" form:"question_id" xml:"question_id"`
	// UserId defined 用户ID
	...
	// AnswerCount defined 回答数量
	AnswerCount null.Int `xorm:"int(11) notnull default(0) comment('回答数量') 'answer_count'" json:"answer_count" form:"answer_count" xml:"answer_count"`
	...
	// LastAnswerTime defined 最后回答时间
	LastAnswerTime null.Int `xorm:"int(10) notnull default(0) comment('最后回答时间') 'last_answer_time'" json:"last_answer_time" form:"last_answer_time" xml:"last_answer_time"`
...
// With defined
func (m *McQuestion) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *McQuestion) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *McQuestion) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *McQuestion) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *McQuestion) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *McQuestion) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *McQuestion) PrimaryKeys(db *xorm.Engine) ([]string, error) {
	v := reflect.Indirect(reflect.ValueOf(m))
	table, err := m.Parser(db).Parse(v)
	return table.PrimaryKeys, err
}

// TableName table name of defined McQuestion
func (m *McQuestion) TableName() string {
	return "mc_question"
}
