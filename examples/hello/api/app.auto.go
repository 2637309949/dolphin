...
// ArticleSrv defined
func ArticleSrvService(dol *Dolphin) {
	dol.RPC.RegisterServer(func(srv *grpc.Server) { proto.RegisterArticleSrvServer(srv, &rpc.ArticleSrv{}) })
}
...
func (dol *Dolphin) SyncSrv(svc svc.Svc) error {
	ArticleInstance.Srv.Svc = svc
	return nil
}

// SyncService defined
func (dol *Dolphin) SyncService() error {
	ArticleSrvService(dol)
	return nil
}
