...
// With defined
func (m *NetworkActivity) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *NetworkActivity) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *NetworkActivity) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *NetworkActivity) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *NetworkActivity) FromMap(fm map[string]interface{}) error {
