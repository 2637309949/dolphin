...
// Marshal defined
func (m *Sheng) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *Sheng) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *Sheng) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *Sheng) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *Sheng) PrimaryKeys(db *xorm.Engine) ([]string, error) {
