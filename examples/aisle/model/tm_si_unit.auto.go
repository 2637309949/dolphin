...
// With defined
func (m *TmSiUnit) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *TmSiUnit) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *TmSiUnit) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *TmSiUnit) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *TmSiUnit) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *TmSiUnit) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *TmSiUnit) PrimaryKeys(db *xorm.Engine) ([]string, error) {
