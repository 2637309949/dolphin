...
// With defined
func (m *NetworkActivityHead) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *NetworkActivityHead) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *NetworkActivityHead) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *NetworkActivityHead) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *NetworkActivityHead) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *NetworkActivityHead) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *NetworkActivityHead) PrimaryKeys(db *xorm.Engine) ([]string, error) {
