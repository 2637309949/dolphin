...
// StudentClassYpk defined
type StudentClassYpk struct {
	// SCYId defined
...
// Marshal defined
func (m *StudentClassYpk) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *StudentClassYpk) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *StudentClassYpk) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *StudentClassYpk) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StudentClassYpk) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *StudentClassYpk) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *StudentClassYpk) PrimaryKeys(db *xorm.Engine) ([]string, error) {
	v := reflect.Indirect(reflect.ValueOf(m))
	table, err := m.Parser(db).Parse(v)
	return table.PrimaryKeys, err
}

// TableName table name of defined StudentClassYpk
func (m *StudentClassYpk) TableName() string {
	return "student_class_ypk"
}
