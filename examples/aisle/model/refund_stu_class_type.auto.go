...
// Marshal defined
func (m *RefundStuClassType) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *RefundStuClassType) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *RefundStuClassType) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *RefundStuClassType) FromMap(fm map[string]interface{}) error {
