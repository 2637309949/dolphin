...
// With defined
func (m *ExamPaperProType) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *ExamPaperProType) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ExamPaperProType) FromMap(fm map[string]interface{}) error {
