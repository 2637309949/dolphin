...
// With defined
func (m *SchTaTargetplan) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *SchTaTargetplan) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SchTaTargetplan) FromMap(fm map[string]interface{}) error {
