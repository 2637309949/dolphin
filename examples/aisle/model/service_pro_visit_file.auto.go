...
// With defined
func (m *ServiceProVisitFile) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *ServiceProVisitFile) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ServiceProVisitFile) FromMap(fm map[string]interface{}) error {
