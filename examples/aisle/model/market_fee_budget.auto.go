...
// With defined
func (m *MarketFeeBudget) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *MarketFeeBudget) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *MarketFeeBudget) FromMap(fm map[string]interface{}) error {
