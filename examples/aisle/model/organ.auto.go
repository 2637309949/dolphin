...
// Marshal defined
func (m *Organ) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *Organ) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *Organ) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *Organ) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *Organ) FromMap(fm map[string]interface{}) error {
