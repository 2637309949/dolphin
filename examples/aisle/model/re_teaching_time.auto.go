...
// With defined
func (m *ReTeachingTime) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *ReTeachingTime) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *ReTeachingTime) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *ReTeachingTime) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ReTeachingTime) FromMap(fm map[string]interface{}) error {
