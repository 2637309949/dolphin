...
// With defined
func (m *LearningparkBackgroundMap) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *LearningparkBackgroundMap) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *LearningparkBackgroundMap) FromMap(fm map[string]interface{}) error {
