...
// Marshal defined
func (m *PaActiveReservation) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *PaActiveReservation) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *PaActiveReservation) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *PaActiveReservation) FromMap(fm map[string]interface{}) error {
