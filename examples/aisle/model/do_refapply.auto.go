...
// With defined
func (m *DoRefapply) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *DoRefapply) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *DoRefapply) FromMap(fm map[string]interface{}) error {
