...
// Marshal defined
func (m *StuSatisfyVisitContent) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *StuSatisfyVisitContent) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StuSatisfyVisitContent) FromMap(fm map[string]interface{}) error {
