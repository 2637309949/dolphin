...
// With defined
func (m *CmStandardOperation) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *CmStandardOperation) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *CmStandardOperation) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *CmStandardOperation) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *CmStandardOperation) PrimaryKeys(db *xorm.Engine) ([]string, error) {
