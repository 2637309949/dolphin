...
// Marshal defined
func (m *SystemMessage) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *SystemMessage) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SystemMessage) FromMap(fm map[string]interface{}) error {
