...
// With defined
func (m *ParentalEvaluation) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *ParentalEvaluation) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *ParentalEvaluation) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *ParentalEvaluation) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ParentalEvaluation) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *ParentalEvaluation) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *ParentalEvaluation) PrimaryKeys(db *xorm.Engine) ([]string, error) {
