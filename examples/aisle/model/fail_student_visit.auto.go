...
// With defined
func (m *FailStudentVisit) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *FailStudentVisit) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *FailStudentVisit) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *FailStudentVisit) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *FailStudentVisit) FromMap(fm map[string]interface{}) error {
