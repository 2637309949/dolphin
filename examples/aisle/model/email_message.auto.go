...
type EmailMessage struct {
	// T100 defined
	T100 null.Int `xorm:"int(11) pk notnull autoincr 't_10_0'" json:"t_10_0" form:"t_10_0" xml:"t_10_0"`
	// Title defined
...
// Marshal defined
func (m *EmailMessage) Marshal() ([]byte, error) {
...
// ToMap defined
func (m *EmailMessage) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *EmailMessage) FromMap(fm map[string]interface{}) error {
...
// PrimaryKeys defined
func (m *EmailMessage) PrimaryKeys(db *xorm.Engine) ([]string, error) {
