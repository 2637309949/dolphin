...
// With defined
func (m *StudentReopened) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *StudentReopened) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StudentReopened) FromMap(fm map[string]interface{}) error {
