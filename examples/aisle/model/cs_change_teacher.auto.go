...
// Marshal defined
func (m *CsChangeTeacher) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *CsChangeTeacher) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *CsChangeTeacher) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *CsChangeTeacher) FromMap(fm map[string]interface{}) error {
