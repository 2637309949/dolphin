...
// Marshal defined
func (m *PeriodViolateAbnormalApply) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *PeriodViolateAbnormalApply) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *PeriodViolateAbnormalApply) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *PeriodViolateAbnormalApply) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *PeriodViolateAbnormalApply) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *PeriodViolateAbnormalApply) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *PeriodViolateAbnormalApply) PrimaryKeys(db *xorm.Engine) ([]string, error) {
