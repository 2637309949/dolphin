...
// With defined
func (m *StudentClassYpk31) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *StudentClassYpk31) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *StudentClassYpk31) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *StudentClassYpk31) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StudentClassYpk31) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *StudentClassYpk31) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *StudentClassYpk31) PrimaryKeys(db *xorm.Engine) ([]string, error) {
