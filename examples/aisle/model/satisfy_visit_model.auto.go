...
// Marshal defined
func (m *SatisfyVisitModel) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *SatisfyVisitModel) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SatisfyVisitModel) FromMap(fm map[string]interface{}) error {
