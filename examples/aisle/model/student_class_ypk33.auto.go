...
// Marshal defined
func (m *StudentClassYpk33) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *StudentClassYpk33) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *StudentClassYpk33) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StudentClassYpk33) FromMap(fm map[string]interface{}) error {
...
// PrimaryKeys defined
func (m *StudentClassYpk33) PrimaryKeys(db *xorm.Engine) ([]string, error) {
