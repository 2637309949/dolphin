...
// With defined
func (m *ChangeTeaHisTea) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *ChangeTeaHisTea) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ChangeTeaHisTea) FromMap(fm map[string]interface{}) error {
