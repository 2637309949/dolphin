...
// With defined
func (m *MarketerPlanTarget) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *MarketerPlanTarget) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *MarketerPlanTarget) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *MarketerPlanTarget) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *MarketerPlanTarget) FromMap(fm map[string]interface{}) error {
