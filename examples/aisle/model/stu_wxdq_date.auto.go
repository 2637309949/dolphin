...
// With defined
func (m *StuWxdqDate) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *StuWxdqDate) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *StuWxdqDate) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *StuWxdqDate) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StuWxdqDate) FromMap(fm map[string]interface{}) error {
