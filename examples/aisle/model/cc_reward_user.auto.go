...
// With defined
func (m *CcRewardUser) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *CcRewardUser) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *CcRewardUser) FromMap(fm map[string]interface{}) error {
