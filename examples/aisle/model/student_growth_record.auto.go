...
// With defined
func (m *StudentGrowthRecord) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *StudentGrowthRecord) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StudentGrowthRecord) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *StudentGrowthRecord) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *StudentGrowthRecord) PrimaryKeys(db *xorm.Engine) ([]string, error) {
