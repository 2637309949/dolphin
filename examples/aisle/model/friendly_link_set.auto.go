...
// With defined
func (m *FriendlyLinkSet) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *FriendlyLinkSet) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *FriendlyLinkSet) FromMap(fm map[string]interface{}) error {
