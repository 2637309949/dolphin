...
// Marshal defined
func (m *ClassTypeOrgan) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *ClassTypeOrgan) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ClassTypeOrgan) FromMap(fm map[string]interface{}) error {
