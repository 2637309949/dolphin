...
// With defined
func (m *T19LoginLog) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *T19LoginLog) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *T19LoginLog) FromMap(fm map[string]interface{}) error {
