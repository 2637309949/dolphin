...
// Marshal defined
func (m *ClassChangeTea) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *ClassChangeTea) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ClassChangeTea) FromMap(fm map[string]interface{}) error {
