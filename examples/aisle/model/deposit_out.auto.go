...
// ToMap defined
func (m *DepositOut) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *DepositOut) FromMap(fm map[string]interface{}) error {
...
// PrimaryKeys defined
func (m *DepositOut) PrimaryKeys(db *xorm.Engine) ([]string, error) {
