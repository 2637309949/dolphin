...
// Marshal defined
func (m *AndroidHotfix) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *AndroidHotfix) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *AndroidHotfix) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *AndroidHotfix) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *AndroidHotfix) FromMap(fm map[string]interface{}) error {
