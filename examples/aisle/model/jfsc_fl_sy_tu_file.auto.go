...
// With defined
func (m *JfscFlSyTuFile) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *JfscFlSyTuFile) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *JfscFlSyTuFile) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *JfscFlSyTuFile) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *JfscFlSyTuFile) FromMap(fm map[string]interface{}) error {
