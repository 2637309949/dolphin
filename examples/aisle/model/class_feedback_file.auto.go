...
// With defined
func (m *ClassFeedbackFile) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *ClassFeedbackFile) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *ClassFeedbackFile) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *ClassFeedbackFile) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ClassFeedbackFile) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *ClassFeedbackFile) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *ClassFeedbackFile) PrimaryKeys(db *xorm.Engine) ([]string, error) {
