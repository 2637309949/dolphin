...
// With defined
func (m *ClassProductCategories) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *ClassProductCategories) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ClassProductCategories) FromMap(fm map[string]interface{}) error {
