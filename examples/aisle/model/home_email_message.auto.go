...
// With defined
func (m *HomeEmailMessage) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *HomeEmailMessage) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *HomeEmailMessage) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *HomeEmailMessage) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *HomeEmailMessage) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *HomeEmailMessage) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *HomeEmailMessage) PrimaryKeys(db *xorm.Engine) ([]string, error) {
