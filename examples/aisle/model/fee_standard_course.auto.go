...
// Marshal defined
func (m *FeeStandardCourse) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *FeeStandardCourse) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *FeeStandardCourse) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *FeeStandardCourse) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *FeeStandardCourse) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *FeeStandardCourse) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *FeeStandardCourse) PrimaryKeys(db *xorm.Engine) ([]string, error) {
