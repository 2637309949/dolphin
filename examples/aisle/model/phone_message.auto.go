...
// With defined
func (m *PhoneMessage) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *PhoneMessage) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *PhoneMessage) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *PhoneMessage) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *PhoneMessage) FromMap(fm map[string]interface{}) error {
