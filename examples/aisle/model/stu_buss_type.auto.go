...
// ToMap defined
func (m *StuBussType) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StuBussType) FromMap(fm map[string]interface{}) error {
...
// PrimaryKeys defined
func (m *StuBussType) PrimaryKeys(db *xorm.Engine) ([]string, error) {
