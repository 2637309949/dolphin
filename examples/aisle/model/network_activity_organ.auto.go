...
// Marshal defined
func (m *NetworkActivityOrgan) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *NetworkActivityOrgan) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *NetworkActivityOrgan) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *NetworkActivityOrgan) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *NetworkActivityOrgan) FromMap(fm map[string]interface{}) error {
