...
// With defined
func (m *TrialLessonProType) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *TrialLessonProType) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *TrialLessonProType) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *TrialLessonProType) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *TrialLessonProType) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *TrialLessonProType) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *TrialLessonProType) PrimaryKeys(db *xorm.Engine) ([]string, error) {
