...
// Marshal defined
func (m *DepositOutFlow) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *DepositOutFlow) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *DepositOutFlow) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *DepositOutFlow) FromMap(fm map[string]interface{}) error {
