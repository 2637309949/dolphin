...
// Marshal defined
func (m *JfscFlSytu) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *JfscFlSytu) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *JfscFlSytu) FromMap(fm map[string]interface{}) error {
