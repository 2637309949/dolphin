...
// With defined
func (m *ClassroomTimeResource) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *ClassroomTimeResource) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *ClassroomTimeResource) Unmarshal(data []byte) error {
...
// PrimaryKeys defined
func (m *ClassroomTimeResource) PrimaryKeys(db *xorm.Engine) ([]string, error) {
