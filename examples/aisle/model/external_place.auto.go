...
// With defined
func (m *ExternalPlace) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *ExternalPlace) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *ExternalPlace) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *ExternalPlace) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *ExternalPlace) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *ExternalPlace) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *ExternalPlace) PrimaryKeys(db *xorm.Engine) ([]string, error) {
