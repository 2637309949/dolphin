...
// With defined
func (m *BusinessDepartment) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *BusinessDepartment) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *BusinessDepartment) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *BusinessDepartment) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *BusinessDepartment) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *BusinessDepartment) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *BusinessDepartment) PrimaryKeys(db *xorm.Engine) ([]string, error) {
