...
// Marshal defined
func (m *StuUserDate) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *StuUserDate) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *StuUserDate) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *StuUserDate) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StuUserDate) FromMap(fm map[string]interface{}) error {
