...
// With defined
func (m *DepositOutFile) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *DepositOutFile) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *DepositOutFile) FromMap(fm map[string]interface{}) error {
