...
// With defined
func (m *AppMessageSch) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *AppMessageSch) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *AppMessageSch) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *AppMessageSch) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *AppMessageSch) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *AppMessageSch) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *AppMessageSch) PrimaryKeys(db *xorm.Engine) ([]string, error) {
