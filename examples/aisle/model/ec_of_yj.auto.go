...
// Marshal defined
func (m *EcOfYj) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *EcOfYj) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *EcOfYj) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *EcOfYj) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *EcOfYj) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *EcOfYj) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *EcOfYj) PrimaryKeys(db *xorm.Engine) ([]string, error) {
