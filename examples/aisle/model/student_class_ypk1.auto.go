...
// StudentClassYpk1 defined
type StudentClassYpk1 struct {
	// SCYId defined
...
// With defined
func (m *StudentClassYpk1) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *StudentClassYpk1) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *StudentClassYpk1) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *StudentClassYpk1) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *StudentClassYpk1) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *StudentClassYpk1) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *StudentClassYpk1) PrimaryKeys(db *xorm.Engine) ([]string, error) {
	v := reflect.Indirect(reflect.ValueOf(m))
	table, err := m.Parser(db).Parse(v)
	return table.PrimaryKeys, err
}

// TableName table name of defined StudentClassYpk1
func (m *StudentClassYpk1) TableName() string {
	return "student_class_ypk1"
}
