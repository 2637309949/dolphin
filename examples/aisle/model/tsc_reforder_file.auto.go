...
// Marshal defined
func (m *TscReforderFile) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *TscReforderFile) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *TscReforderFile) FromMap(fm map[string]interface{}) error {
