...
// Marshal defined
func (m *OverseasMaPt) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *OverseasMaPt) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *OverseasMaPt) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *OverseasMaPt) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *OverseasMaPt) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *OverseasMaPt) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *OverseasMaPt) PrimaryKeys(db *xorm.Engine) ([]string, error) {
