...
func (r *CustomerServiceProcess) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalCustomerServiceProcess(data []byte) (CustomerServiceProcess, error) {
	var r CustomerServiceProcess
