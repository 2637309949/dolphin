...
func (r *ParticipantEvaluateTrainer) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalParticipantEvaluateTrainer(data []byte) (ParticipantEvaluateTrainer, error) {
	var r ParticipantEvaluateTrainer
