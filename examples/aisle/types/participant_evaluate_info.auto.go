...
func (r *ParticipantEvaluateInfo) Marshal() ([]byte, error) {
	return json.Marshal(r)
}

func UnmarshalParticipantEvaluateInfo(data []byte) (ParticipantEvaluateInfo, error) {
	var r ParticipantEvaluateInfo
