...
// Marshal defined
func (m *SysTagGroup) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysTagGroup) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysTagGroup) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysTagGroup) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysTagGroup) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysTagGroup) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *SysTagGroup) PrimaryKeys(db *xorm.Engine) ([]string, error) {
