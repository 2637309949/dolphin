...
// With defined
func (m *SysArea) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysArea) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysArea) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysArea) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysArea) FromMap(fm map[string]interface{}) error {
