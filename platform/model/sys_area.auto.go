...
type SysArea struct {
	...
	// 父节点
	Parent null.String `xorm:"varchar(36) comment('父节点') 'parent'" json:"parent" xml:"parent"`
	// 继承关系
	...
	// 模板内容
	TempValue null.String `xorm:"text comment('模板内容') 'temp_value'" json:"temp_value" xml:"temp_value"`
	// 负责人
	Manager null.String `xorm:"varchar(36) comment('负责人') 'manager'" json:"manager" xml:"manager"`
	// 创建人
