...
// With defined
func (m *SysOptionset) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *SysOptionset) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysOptionset) FromMap(fm map[string]interface{}) error {
