...
type SysUserBinding struct {
	...
	// open_id
	OpenId null.String `xorm:"varchar(36) notnull 'open_id'" json:"open_id" xml:"open_id"`
	// union_id
	UnionId null.String `xorm:"varchar(36) notnull 'union_id'" json:"union_id" xml:"union_id"`
	// 类型(0: 微信 1：叮叮)
