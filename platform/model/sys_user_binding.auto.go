...
type SysUserBinding struct {
	...
	// open_id
	OpenId null.String `xorm:"varchar(36) notnull comment('open_id') 'open_id'" json:"open_id" xml:"open_id"`
	// union_id
	UnionId null.String `xorm:"varchar(36) notnull comment('union_id') 'union_id'" json:"union_id" xml:"union_id"`
	// 类型(0: 微信 1：叮叮)
	Type null.Int `xorm:"comment('类型(0: 微信 1：叮叮)') 'type'" json:"type" xml:"type"`
	// 创建人
