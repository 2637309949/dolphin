...
// With defined
func (m *SysUserBinding) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysUserBinding) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysUserBinding) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysUserBinding) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysUserBinding) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysUserBinding) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *SysUserBinding) PrimaryKeys(db *xorm.Engine) ([]string, error) {
