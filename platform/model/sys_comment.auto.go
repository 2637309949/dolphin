...
// With defined
func (m *SysComment) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysComment) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysComment) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysComment) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysComment) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysComment) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *SysComment) PrimaryKeys(db *xorm.Engine) ([]string, error) {
