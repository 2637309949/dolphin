...
// With defined
func (m *SysUserTag) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysUserTag) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysUserTag) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysUserTag) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysUserTag) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysUserTag) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *SysUserTag) PrimaryKeys(db *xorm.Engine) ([]string, error) {
