...
// Marshal defined
func (m *SysMenu) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysMenu) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysMenu) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysMenu) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysMenu) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysMenu) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *SysMenu) PrimaryKeys(db *xorm.Engine) ([]string, error) {
