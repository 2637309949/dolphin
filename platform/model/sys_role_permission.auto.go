...
type SysRolePermission struct {
	...
	// 角色
	RoleId null.String `xorm:"varchar(36) notnull comment('角色') 'role_id'" json:"role_id" xml:"role_id"`
	// 权限
	PermissionId null.String `xorm:"varchar(36) notnull comment('权限') 'permission_id'" json:"permission_id" xml:"permission_id"`
	// 创建人
