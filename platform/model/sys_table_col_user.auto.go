...
// With defined
func (m *SysTableColUser) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysTableColUser) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysTableColUser) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysTableColUser) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysTableColUser) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysTableColUser) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *SysTableColUser) PrimaryKeys(db *xorm.Engine) ([]string, error) {
