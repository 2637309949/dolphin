...
type SysRoleDataPermission struct {
	...
	DataPermissionId null.Int `xorm:"bigint(20) notnull comment('数据权限ID') 'data_permission_id'" json:"data_permission_id" form:"data_permission_id" xml:"data_permission_id"`
	// Creater defined 创建人
...
// With defined
func (m *SysRoleDataPermission) With(s interface{}) (interface{}, error) {
