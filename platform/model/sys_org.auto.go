...
type SysOrg struct {
	...
	// 上级组织
	Parent null.String `xorm:"varchar(36) comment('上级组织') 'parent'" json:"parent" xml:"parent"`
	// 继承关系
	...
	// 领导人
	Leader null.String `xorm:"varchar(36) comment('领导人') 'leader'" json:"leader" xml:"leader"`
	// 编码
	Code null.String `xorm:"varchar(36) comment('编码') 'code'" json:"code" xml:"code"`
	// 组织类型
	Type null.Int `xorm:"comment('组织类型') 'type'" json:"type" xml:"type"`
	// 排序
