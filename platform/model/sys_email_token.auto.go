...
type SysEmailToken struct {
	...
	// 令牌
	Token null.String `xorm:"varchar(36) notnull comment('令牌') 'token'" json:"token" xml:"token"`
	// 邮箱
	Email null.String `xorm:"varchar(36) notnull comment('邮箱') 'email'" json:"email" xml:"email"`
	// 用户ID
