...
// With defined
func (m *SysScheduleHistory) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysScheduleHistory) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysScheduleHistory) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysScheduleHistory) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysScheduleHistory) FromMap(fm map[string]interface{}) error {
