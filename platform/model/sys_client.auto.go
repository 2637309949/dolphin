...
type SysClient struct {
	...
	// 名称
	Name null.String `xorm:"varchar(36) comment('名称') 'name'" json:"name" xml:"name"`
	// 应用归属
	...
	// 应用
	Client null.String `xorm:"varchar(36) comment('应用') 'client'" json:"client" xml:"client"`
	// 密钥
	Secret null.String `xorm:"varchar(36) comment('密钥') 'secret'" json:"secret" xml:"secret"`
	// 创建人
