...
// Marshal defined
func (m *SysPermission) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysPermission) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysPermission) Unmarshal(data []byte) error {
...
// PrimaryKeys defined
func (m *SysPermission) PrimaryKeys(db *xorm.Engine) ([]string, error) {
