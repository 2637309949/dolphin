...
// With defined
func (m *SysAreaTemplate) With(s interface{}) (interface{}, error) {
...
// ToMap defined
func (m *SysAreaTemplate) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysAreaTemplate) FromMap(fm map[string]interface{}) error {
