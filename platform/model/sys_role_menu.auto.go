...
type SysRoleMenu struct {
	...
	// 用户ID
	RoleId null.String `xorm:"varchar(36) notnull comment('用户ID') 'role_id'" json:"role_id" xml:"role_id"`
	// 菜单ID
	MenuId null.String `xorm:"varchar(36) notnull comment('菜单ID') 'menu_id'" json:"menu_id" xml:"menu_id"`
	// 创建人
