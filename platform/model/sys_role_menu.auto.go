...
// Marshal defined
func (m *SysRoleMenu) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysRoleMenu) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysRoleMenu) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysRoleMenu) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysRoleMenu) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysRoleMenu) Parser(db *xorm.Engine) *tags.Parser {
	return tags.NewParser("xorm", db.Dialect(), db.DB().Mapper, db.DB().Mapper, caches.NewManager())
}

// PrimaryKeys defined
func (m *SysRoleMenu) PrimaryKeys(db *xorm.Engine) ([]string, error) {
