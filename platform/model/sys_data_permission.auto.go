...
// With defined
func (m *SysDataPermission) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysDataPermission) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysDataPermission) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysDataPermission) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysDataPermission) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysDataPermission) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *SysDataPermission) PrimaryKeys(db *xorm.Engine) ([]string, error) {
