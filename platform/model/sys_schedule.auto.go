...
// With defined
func (m *SysSchedule) With(s interface{}) (interface{}, error) {
...
// Marshal defined
func (m *SysSchedule) Marshal() ([]byte, error) {
	return json.Marshal(m)
}

// Unmarshal defined
func (m *SysSchedule) Unmarshal(data []byte) error {
	return json.Unmarshal(data, m)
}

// ToMap defined
func (m *SysSchedule) ToMap() (map[string]interface{}, error) {
	byt, err := m.Marshal()
	if err != nil {
		return nil, err
	}
...
// FromMap defined
func (m *SysSchedule) FromMap(fm map[string]interface{}) error {
...
// Parser defined
func (m *SysSchedule) Parser(db *xorm.Engine) *tags.Parser {
	dialect, mapper, cache := db.Dialect(), db.DB().Mapper, caches.NewManager()
	return tags.NewParser("xorm", dialect, mapper, mapper, cache)
}

// PrimaryKeys defined
func (m *SysSchedule) PrimaryKeys(db *xorm.Engine) ([]string, error) {
