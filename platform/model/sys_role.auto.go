...
type SysRole struct {
	...
	// 角色app首页url
	AppIndex null.String `xorm:"varchar(500) comment('角色app首页url') 'app_index'" json:"app_index" xml:"app_index"`
	// 角色进入后台首页组件
	AdminIndex null.String `xorm:"varchar(500) comment('角色进入后台首页组件') 'admin_index'" json:"admin_index" xml:"admin_index"`
	// 创建人
