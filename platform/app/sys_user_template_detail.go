...
func SysUserTemplateDetailDel(ctx *Context) {
	...
	ret, err := ctx.DB.In("id", payload.ID.Int64).Update(&model.SysUserTemplateDetail{
...
func SysUserTemplateDetailBatchDel(ctx *Context) {
	...
	var ids = funk.Map(payload, func(form model.SysUserTemplateDetail) int64 { return form.ID.Int64 }).([]int64)
