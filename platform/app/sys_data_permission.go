...
func SysDataPermissionDel(ctx *Context) {
	...
	ret, err := ctx.DB.In("id", payload.ID.Int64).Update(&model.SysDataPermission{
...
func SysDataPermissionBatchDel(ctx *Context) {
	...
	var ids = funk.Map(payload, func(form model.SysDataPermission) int64 { return form.ID.Int64 }).([]int64)
