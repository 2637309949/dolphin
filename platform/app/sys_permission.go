...
func SysPermissionDel(ctx *Context) {
	...
	ret, err := ctx.DB.In("id", payload.ID.Int64).Update(&model.SysPermission{
...
func SysPermissionBatchDel(ctx *Context) {
	...
	var ids = funk.Map(payload, func(form model.SysPermission) int64 { return form.ID.Int64 }).([]int64)
