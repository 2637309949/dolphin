...
func SysNotificationDel(ctx *Context) {
	...
	ret, err := ctx.DB.In("id", payload.ID.Int64).Update(&model.SysNotification{
...
func SysNotificationBatchDel(ctx *Context) {
	...
	var ids = funk.Map(payload, func(form model.SysNotification) int64 { return form.ID.Int64 }).([]int64)
