...
// @Param user body types.SysTable false "表信息"
...
// @Accept application/json
// @Param Authorization header string false "认证令牌"
// @Param sys_table body []types.SysTable false "表信息"
// @Produce application/json
// @Failure 403 {object} types.Fail
// @Success 200 {object} types.Success
// @Failure 500 {object} types.Fail
...
// @Accept application/json
// @Param Authorization header string false "认证令牌"
// @Param sys_table body types.SysTable false "表"
// @Produce application/json
// @Failure 403 {object} types.Fail
// @Success 200 {object} types.Success
// @Failure 500 {object} types.Fail
...
func (ctr *SysTable) SysTableDel(ctx *Context) {
	...
	ret, err := ctx.MustDB().In("id", payload.ID.Int64).Update(&types.SysTable{
...
func (ctr *SysTable) SysTableBatchDel(ctx *Context) {
	...
	var ids = funk.Map(payload, func(form types.SysTable) int64 { return form.ID.Int64 }).([]int64)
	ret, err := ctx.MustDB().In("id", ids).Update(&types.SysTable{
		UpdateTime: null.TimeFromNow(),
		Updater:    null.IntFromStr(ctx.MustToken().GetUserID()),
		IsDelete:   null.IntFrom(1),
	})
...
// @Accept application/json
// @Param Authorization header string false "认证令牌"
// @Param user body types.SysRole false "表信息"
// @Produce application/json
// @Failure 403 {object} types.Fail
// @Success 200 {object} types.Success
// @Failure 500 {object} types.Fail
...
func (ctr *SysTable) SysTablePage(ctx *Context) {
	...
	if ctr.Srv.Report.Check(ctx.Request()) {
		...
		ret, err := ctr.Srv.Report.PageExport(ctx.MustDB(), "sys_table", "page", "sys_table", q.Value())
		if err != nil {
			logrus.Error(err)
			ctx.Fail(err)
			return
	...
	ret, err := ctr.Srv.DB.PageSearch(ctx.MustDB(), "sys_table", "page", "sys_table", q.Value())
	if err != nil {
		logrus.Error(err)
		ctx.Fail(err)
		return
