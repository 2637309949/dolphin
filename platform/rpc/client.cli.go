...
func NewClientSrvClient(target string, opts ...grpc.DialOption) (proto.ClientSrvClient, error) {
	...
	return proto.NewClientSrvClient(conn), nil
}
...
func init() {
	go func() {
		...
		var err error
		ClientSrvClient, err = NewClientSrvClient(viper.GetString("rpc.client_srv"))
		if err != nil {
