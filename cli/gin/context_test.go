...
import (
	...
	testdata "github.com/2637309949/dolphin/cli/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/2637309949/dolphin/cli/gin.handlerNameTest$", c.HandlerName())
}
