...
<application name="%v" desc="dolphin template" packagename="%v">
    <controllers>
        <controller name="base_article" desc="文章接口定义">
            <api name="add" func="add" table="base_article" desc="添加文章" method="post">
            ...
            <api name="del" func="delete" table="base_article" desc="删除文章" method="delete">
            ...
            <api name="update" func="update" table="base_article" desc="更新文章" method="put">
                <param name="user" type="$base_article" desc="文章信息" />
                <return>
                    <success type="$success"/>
                    <failure type="$fail"/>
            ...
            <api name="page" func="page" table="base_article" desc="文章分页查询" method="get">
            ...
            <api name="get" desc="获取文章信息" func="one" table="base_article" method="get">
